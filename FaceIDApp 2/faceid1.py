...
class CamApp(App):
    ...
    def build(self):
        ...
        self.button = Button(text="Classify Waste", on_press=self.verify, size_hint=(1,.1))
        ...
        self.model = tf.keras.models.load_model('resnet_model1.h5', custom_objects={'L1Dist':L1Dist})
